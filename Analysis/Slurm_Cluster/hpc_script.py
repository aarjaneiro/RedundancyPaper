...
# Jan 26 -- Changes parallelism --> across sims vs across toOrder
import numpy as np
...
class Concurrent:
    ...
    def RSim(self,  reps):
        ...
        testvalues = []
        for N in (self.order):
            _sim = RedundancyQueueSystem(maxTime=self.maxtime, parallelism=N, seed=self.seed + 2331 * N + reps, d=self.d,
