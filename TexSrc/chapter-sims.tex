...
\begin{lstlisting}[label={lst:red}, caption={Using \textit{ParallelQueue} to simulate a Redundancy(2) system}, language={Python}, style={mystyle}]
#!/usr/bin/python3
...
sim = RedundancyQueueSystem(
                    ...
                    AArgs=9,Q3 Service=random.expovariate,
